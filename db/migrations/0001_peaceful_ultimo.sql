...
--> statement-breakpoint
ALTER TABLE "invitations" DROP CONSTRAINT "invitations_invited_by_id_profiles_id_fk";
--> statement-breakpoint
ALTER TABLE "organization_members" DROP CONSTRAINT "organization_members_user_id_profiles_id_fk";
--> statement-breakpoint
ALTER TABLE "knowledge_sources" ADD COLUMN "embedding" vector(768);--> statement-breakpoint
